...
function begin_play()
{
  ...
  var player2 = document.getElementById("player2_id")
    ...
    else
    {
      ...
      document.getElementById("turn_info").innerHTML = "Turn: " + player1.value;
	...
	{
		alert("Game in progress, please click 'Reset Play' to start another game")
	}
}
...
function reset_play()
{
  ...
  document.getElementById("turn_info").innerHTML = "No game in progress";
...
{ 
  ...
  // check if there are 3 horizontally
  if (table_ids[0] == 1 && table_ids[1] == 1 && table_ids[2] == 1)
  {
    return 1;
  }
  if (table_ids[3] == 1 && table_ids[4] == 1 && table_ids[5] == 1)
  {
    return 1;
  }
  if (table_ids[6] == 1 && table_ids[7] == 1 && table_ids[8] == 1)
  {
    return 1;
  }

  // check if there are 3 diagonally
  if (table_ids[0] == 1 && table_ids[4] == 1 && table_ids[8] == 1)
  {
    return 1;
  }
  if (table_ids[2] == 1 && table_ids[4] == 1 && table_ids[6] == 1)
  {
    return 1;
  }

  // check if there are 3 vertically
  if (table_ids[0] == 1 && table_ids[3] == 1 && table_ids[6] == 1)
  {
    return 1;
  }
  if (table_ids[1] == 1 && table_ids[4] == 1 && table_ids[7] == 1)
  {
    return 1;
  }
  if (table_ids[2] == 1 && table_ids[5] == 1 && table_ids[8] == 1)
  {
    return 1;
  }
  ...
  // check if there are 3 horizontally
  if (table_ids[0] == 0 && table_ids[1] == 0 && table_ids[2] == 0)
  {
    return 0;
  }
  if (table_ids[3] == 0 && table_ids[4] == 0 && table_ids[5] == 0)
  {
    return 0;
  }
  if (table_ids[6] == 0 && table_ids[7] == 0 && table_ids[8] == 0)
  {
    return 0;
  }

  // check if there are 3 diagonally
  if (table_ids[0] == 0 && table_ids[4] == 0 && table_ids[8] == 0)
  {
    return 0;
  }
  if (table_ids[2] == 0 && table_ids[4] == 0 && table_ids[6] == 0)
  {
    return 0;
  }

  // check if there are 3 vertically
  if (table_ids[0] == 0 && table_ids[3] == 0 && table_ids[6] == 0)
  {
    return 0;
  }
  if (table_ids[1] == 0 && table_ids[4] == 0 && table_ids[7] == 0)
  {
    return 0;
  }
  if (table_ids[2] == 0 && table_ids[5] == 0 && table_ids[8] == 0)
  {
    return 0;
  }
}
...
{ 
    ...
    if (table_ids[input] == "0" || table_ids[input] == "1")
    {
      alert("Invalid move");
      return 0;
    }
...
function play() {
  ...
  if (started == true)
  {
    if (turns < 10)
    {
      ...
      if (validMove(fixedInput) == 1)
      {
        
        //alert("Move validated")
        if (turns == 1 || turns == 3 || turns == 5 || turns == 7 || turns == 9)
        {
          document.getElementById(input).innerHTML = "X";
          //alert("X placed");
          
          table_ids[fixedInput] = 1;
          for (var i = 0; i < 9; i++)
          {
            console.log(table_ids[i])
          }
          checkWin();
          document.getElementById("turn_info").innerHTML = "Turn: " + player2.value;
