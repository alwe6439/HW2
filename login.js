function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        var lowerCaseLetters = /[a-z]/g; //dummy_regex/g; // : Fill in the regular experssion for lowerCaseLetters
        var upperCaseLetters = /[A-Z]/g; //dummy_regex/g; // : Fill in the regular experssion for upperCaseLetters
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = letter && capital && number && length && match; // TODO: Replace false with the correct condition
    if(condition) {       
